...
<table class="table table-bordered table-hover" id="dataTable" width="100%" cellspacing="0">
    ...
    <tbody>
        ...
        $Instructores = $DB_con->prepare("SELECT instructores.*, users.* FROM instructores INNER JOIN users ON instructores.id_user = users.id_user WHERE instructores.id_adminCarrera =:uid ORDER BY nombre_instructor ASC");
        ...
        while ($row = $Instructores->fetch(PDO::FETCH_OBJ)) { ?>
            <tr>
                ...
                <td>
                   <a href="editar_instructor.php?id=<?php echo $row->id_instructor; ?>"> <button class="btn btn-datatable btn-icon btn-transparent-dark" id="editar_instructor"><i class="fas fa-edit"></i></button></a>
