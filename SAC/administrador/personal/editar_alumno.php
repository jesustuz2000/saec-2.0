...
// datos del Alumnos
$consulta = $DB_con->prepare('SELECT users.*, alumnos.* FROM users INNER JOIN alumnos ON users.id_user = alumnos.id_user WHERE alumnos.id_alumno  = :id_alumno');
$consulta->execute(array(':id_alumno' => $_GET['id']));
$datosAlumno = $consulta->fetch(PDO::FETCH_ASSOC);
extract($datosAlumno);

// COMPROBAR QUE EL ALUMNO ES EL MISMO QUE EL ADMINISTRADOR
if ($datosCarrera['id_adminCarrera'] <> $datosAlumno['id_adminCarrera']) {
    ...
    if (!isset($errMSG)) {
        ...
        if (isset($_POST['password']) && $_POST['password'] <> null) {
            try {
                ...
                // tabla ALUMNOS
                $sql = 'UPDATE alumnos SET nombre_alumno=:nombre_alumno,
                apellido_alumno=:apellido_alumno,
                matricula =:matricula,
                semestre_grupo=:semestre_grupo
                WHERE id_user = :id_user';

                $result = $DB_con->prepare($sql);
                $result->bindValue(':nombre_alumno', $nombres, PDO::PARAM_STR);
                $result->bindValue(':apellido_alumno', $apellidos, PDO::PARAM_STR);
                ...
                $successMSG = "Editado Exitosamente";
            ...
            <main>
                    ...
                    <div class="container-fluid">
                        <div class="page-header-content py-5">
                            <h1 class="page-header-title">
                                <span>Actulizar Alumno</span>
                            </h1>
                            <ol class="breadcrumb mt-4 mb-0">
                                <li class="breadcrumb-item"><a href="index.php">Inicio</a></li>
                                <li class="breadcrumb-item"><a href="alumnos.php">Alumnos</a></li>
                                <li class="breadcrumb-item active">Actulizar Alumno</li>
                            </ol>
                        </div>
                    </div>
                </div>
                ...
                <form method="post" enctype="multipart/form-data" class="listar-formtheme listar-formaddlisting">
                    <div class="container-fluid mt-4">
                        <div id="solid">
                            <div class="card mb-4">
                                <div class="card-header">Actulizar Alumno</div>
                                <div class="card-body">
                                    <div class="sbp-">
                                        <div class="sbp-preview-content">
                                            <input type="hidden" name="id_user" value="<?php echo $datosAlumno['id_user'];?>" id="">
                                            <div class="form-group">
                                                <label for="exampleFormControlInput1">Nombre(s)</label>
                                                <input class="form-control form-control-solid" id="exampleFormControlInput1" type="text" name="nombres" placeholder="Nombre(s) del alumno" maxlength="40" value="<?php echo $datosAlumno['nombre_alumno'];?>" required>
                                            </div>
                                            <div class="form-group">
                                                <label for="exampleFormControlInput1">Apellidos</label>
                                                <input class="form-control form-control-solid" id="exampleFormControlInput1" type="text" name="apellidos" placeholder="Apellidos del alumno" maxlength="40" value="<?php echo $datosAlumno['apellido_alumno'];?>" required>
                                            </div>
                                            <div class="form-group">
                                                <label for="exampleFormControlInput1">Matricula</label>
                                                <input class="form-control form-control-solid" id="exampleFormControlInput1" type="number" name="matricula" placeholder="Matricula del alumno" min="0" value="<?php echo $datosAlumno['matricula'];?>" required>
                                            </div>
                                            <div class="form-group">
                                                <div class="form-group">
                                                    <label for="my-select">Semestre y grupo</label>
                                                    <select id="my-select" class="form-control" name="semestre_grupo">
                                <?php
                                ...
                                while ($row = $semestre_grupo->fetch(PDO::FETCH_OBJ)) {
                                    if ($datosAlumno['semestre_grupo'] == $row->semestre_grupo) {
                                        ...
                                        echo '</option>';
                                            ...
                                            <div class="form-group">
                                                ...
                                                <input  class="form-control form-control-solid"  type="email" name="email" placeholder="Correo Institucional" value="<?php echo $datosAlumno['correo_user'];?>" <?php
                                            ...
                                            <div class="form-group">
                                                ...
                                                <input ID="txtPassword" type="text"  class="form-control form-control-solid" name="password" placeholder="Contraseña" minlength="8" maxlength="16" pattern="^(?=\w*\d)(?=\w*[A-Z])(?=\w*[a-z])\S{8,16}$">
                        ...
                        <button class="" name="btnedit">Guardar</button>
