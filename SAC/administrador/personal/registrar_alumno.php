...
// echo $datosCarrera['id_adminCarrera'];
...
if (isset($_POST['btnsave'])) {
    ...
    $id_adminCarrera =  $datosCarrera['id_adminCarrera']; //id de la carrera
    $id_rol = 4; //rol alumno
    $status_alumno = 1; //Enviamos como activo
    ...
    if (empty($correo_user)) {
        $errMSG = "Todos los campos son abligatorios";
    } else if (empty($pass)) {
        $errMSG = "Todos los campos son abligatorios";
    }
    ...
    if (!isset($errMSG)) {
        ...
        try {
            ...
            // tabla alumnos
            $sql = 'INSERT INTO alumnos(nombre_alumno,apellido_alumno,matricula,semestre_grupo,status_alumno,comentarios,id_user,id_adminCarrera,id_taller,id_concurso,id_equipo) VALUES(:nombre_alumno, :apellido_alumno, :matricula, :semestre_grupo, :status_alumno, :comentarios, :id_user, :id_adminCarrera, :id_taller, :id_concurso, :id_equipo)';
            $result = $DB_con->prepare($sql);
                                    ...
                                    <div class="sbp-">
                                        <div class="sbp-preview-content">
                                            ...
                                            <div class="form-group">
                                                ...
                                                <input class="form-control form-control-solid" id="exampleFormControlInput1" type="text" name="nombres" placeholder="Nombre(s) del alumno" maxlength="40" value="" required>
                                            </div>
                                            <div class="form-group">
                                                <label for="exampleFormControlInput1">Apellidos</label>
                                                <input class="form-control form-control-solid" id="exampleFormControlInput1" type="text" name="apellidos" placeholder="Apellidos del alumno" maxlength="40" value="" required>
                                            </div>
                                            <div class="form-group">
                                                <label for="exampleFormControlInput1">Matricula</label>
                                                <input class="form-control form-control-solid" id="exampleFormControlInput1" type="number" name="matricula" placeholder="Matricula del alumno" min="0" value="" required>
                                            </div>
                                            <div class="form-group">
                                                <div class="form-group">
                                    ...
                                    if ($rowAlumnos['semestre_grupo'] == $row->semestre_grupo) {
                                        ...
                                        echo '</option>';
                                            ...
                                            <div class="form-group">
                                                ...
                                                <input  class="form-control form-control-solid"  type="email" name="email" placeholder="Correo Institucional" <?php
                                            ...
                                            <div class="form-group">
                                                ...
                                                <input ID="txtPassword" type="text"  class="form-control form-control-solid" name="password" placeholder="Contraseña" minlength="8" maxlength="16" pattern="^(?=\w*\d)(?=\w*[A-Z])(?=\w*[a-z])\S{8,16}$" required>
