...
if (isset($_POST['btnsave'])) {
    ...
    $clave = ' ';
    $status_instructor = 1; //Enviamos como Activo
                    ...
                    <div class="container-fluid">
                        <div class="page-header-content py-5">
                            ...
                            <ol class="breadcrumb mt-4 mb-0">
                                ...
                                <li class="breadcrumb-item active">Nuevo Instructor</li>
                            </ol>
                        </div>
                    </div>
                </div>
                                    ...
                                    <div class="sbp-">
                                        <div class="sbp-preview-content">
                                            ...
                                            <div class="form-group">
                                                ...
                                                <input class="form-control form-control-solid" id="exampleFormControlInput1" type="text" name="nombres" placeholder="Nombre del instructor" maxlength="40" value="" required>
                                            </div>
                                            <div class="form-group">
                                                <label for="exampleFormControlInput1">Apellidos</label>
                                                <input class="form-control form-control-solid" id="exampleFormControlInput1" type="text" name="apellidos" placeholder="Apellidos del instructor" maxlength="40" value="" required>
                                            </div>
                                            <div class="form-group">
