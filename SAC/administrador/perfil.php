...
if (isset($_POST['datos'])) {
    ...
    try {
        $sentencia = $DB_con->prepare("UPDATE admin_carreras SET nombre_adminCarrera = ?, carrera = ? WHERE id_user = ?;");
        $resultado = $sentencia->execute([$_POST['nombre'], $_POST['carrera'], $_SESSION["id_administrador_carrera"]]);
...
if (isset($_POST['usuario'])) {
    ...
    try {
        ...
        $resultado = $sentencia->execute([$_POST['correo'], $_SESSION["id_administrador_carrera"]]);
        ...
        while ($registro = $resultado->fetch(PDO::FETCH_ASSOC)) {
            ...
            if (password_verify($clave, $registro['password'])) {
                ...
                try {
                    ...
                    $resultado = $sentencia->execute([$password, $_SESSION["id_administrador_carrera"]]);
        ...
        <div id="layoutSidenav_content">
            <main>
                <div class="page-header pb-10 page-header-dark bg-gradient-primary-to-secondary">
                    <div class="container-fluid">
                        <div class="page-header-content">
                            ...
                            if (isset($errMSG)) {
                            ?>
                                <div class="alert alert-danger"> <span class="glyphicon glyphicon-info-sign"></span> <strong>Datos NO actualizados, por favor verifique que la información sea la correcta.</strong> </div>
                            <?php
                            }
                            ?>
                        </div>
                ...
                <div class="container-fluid mt-n10">
                    <div class="card mb-4">
                        <div class="card-header">Datos públicos</div>
                        <div class="card-body">
                            <form action="perfil.php" method="post">
                                <div class="form-group">
                                <label for="exampleFormControlSelect1">Carrera</label>
                                    <input type="text" class="form-control" id="exampleFormControlSelect1" name="carrera" value="<?php echo $datos['carrera']; ?>" maxlength="50" required>
                        ...
                        <div class="card-body">
                            <form action="perfil.php" method="post">
                                <div class="form-group">
                                    ...
                                    <input class="form-control" type="password" name="pass1" minlength="8" maxlength="16" pattern="^(?=\w*\d)(?=\w*[A-Z])(?=\w*[a-z])\S{8,16}$" required>
