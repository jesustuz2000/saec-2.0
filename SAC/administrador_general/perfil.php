...
echo $_SESSION["id_administrador_general"];

// DATOS DEL ADMIN
$consultaIns = $DB_con->prepare('SELECT * FROM users WHERE id_user = :id_user');
$consultaIns->execute(array(':id_user' => $_SESSION["id_administrador_general"]));
...
if (isset($_POST['usuario'])) {
    ...
    try {
        ...
        $resultado = $sentencia->execute([$_POST['correo'], $_SESSION["id_administrador_general"]]);
        ...
        while ($registro = $resultado->fetch(PDO::FETCH_ASSOC)) {
            ...
            if (password_verify($clave, $registro['password'])) {
                ...
                try {
                    ...
                    $resultado = $sentencia->execute([$password, $_SESSION["id_administrador_general"]]);
                        ...
                        <div class="card-body">
                            <form action="perfil.php" method="post">
                                <div class="form-group">
                                    ...
                                    <label for="exampleFormControlSelect1">Contraseña Actual</label>
